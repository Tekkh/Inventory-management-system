...
<!-- ------------------------------------------------------------------------Navbar ---------------------------------------------------------->
	...
	<!-- ------------------------------------------------------------------------End of Navbar ---------------------------------------------------------->
	<div  class="TKprod">
		 <h1><strong>Entrée Produit </strong></h1><br>
		 	...
		 	<tbody>
		 			<?php 
                        ...
                        while($prod = mysqli_fetch_assoc($result)) 
                        {
                            ...
                            echo '<td width=110>';
                            echo '<a class="btn btn-success" href="Entree.php?code_prod='.$prod['code_prod'].'"><span class="glyphicon glyphicon-plus"></span> Entrer</a>';
                            echo ' ';
                            echo '</td>';
                            echo '</tr>';
                        }
