                ...
                if($isSuccess) 
                {
                    ...
                    if ($qte>0)
                    {
            					if ($cnx->query($statement) === TRUE) {
                                    ...
                                    echo ' Le produit est entrée avec <strong>succés!</strong>';
                                    echo '</div>';
                                	
            					} else {
                                   echo '<div id="echec" class="alert alert-danger alert-dismissible">';
                                   echo '<a href="produitentr.php" class="close" data-dismiss="alert" aria-label="close">&times</a>';
                                   echo ' Entrée de produit est <strong>echoué!</strong>';
                                   echo '</div>';
            					}
                    } else{
...
<body>
	...
	<div class="TKprod">
		<div class="row">
                <h1><strong>Entrée Produit</strong></h1>
                <br>
                <form class="form" action="<?php echo 'Entree.php?code_prod='.$code_prod;?>" role="form" method="post">
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> Entrer</button>
                        <a class="btn btn-primary" href="produitentr.php"><span class="glyphicon glyphicon-arrow-left"></span> Retour</a>
                   </div>
                </form>
            </div>
         </div>   
