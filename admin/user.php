...
<!-----------------------------------------------------------------------Navbar--------------------------------------------------------------------------------->
	...
	<div  class="TKprod">
		 <h1><strong>Liste des utilisateurs </strong>
		 	<a class="btn btn-success btn-lg" href="user/AjouterUser.php"> <span class="glyphicon glyphicon-plus"></span> Ajouter</a></h1>&nbsp;</h1> 
		 	...
		 	<tbody>
		 			<?php 
                        ...
                        while($user= mysqli_fetch_assoc($result)) 
                        {
                            ...
                            echo '<td width=300>';
                            echo ' ';
                            echo '<a class="btn btn-primary" href="user/editUser.php?id='.$user['id'].'"><span class="glyphicon glyphicon-pencil"></span> Modifier</a>';
                            echo ' ';
                            echo '<a class="btn btn-danger" href="user/delUser.php?id='.$user['id'].'"><span class="glyphicon glyphicon-remove"></span> Supprimer</a>';
                            echo '</td>';
                            echo '</tr>';
                        }
