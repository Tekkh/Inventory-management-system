...
<body>
	  ...
	  <div class="container-fluid">
	    ...
	    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	      	<ul class="nav navbar-nav">
					...
					<ul class="dropdown-menu">
	           		<li><a href="deplaceprod.php">Déplacer Produit</a></li>
	...
	<!-- ------------------------------------------------------------------------End of Navbar ---------------------------------------------------------->
		...
		<div  class="TKprod">
		 <h1><strong>Déplacement Produit </strong></h1><br>
		 	...
		 	<tbody>
		 			<?php 
                        ...
                        while($prod = mysqli_fetch_assoc($result)) 
                        {
                            ...
                            echo '<td width=110>';
                            echo '<a class="btn btn-success" href="Deplacer.php?code_prod='.$prod['code_prod'].'"><span class="glyphicon glyphicon-transfer"></span> Déplacer</a>';
                            echo ' ';
                            echo '</td>';
                            echo '</tr>';
                        }
