...
<body>
	...
	<div  class="TKprod">
		 <h1><strong>Liste des déplacements </strong></h1><br>
		 <table class="table table-strip	ed table-bordered">
		 	<thead>
		 		<tr>
		 			<th>Code déplacement</th>
		 			<th>Origine</th>
		 			<th>Destination</th>
		 			<th>Description</th>
		 			<th>Quantité</th>
		 	...
		 	<tbody>
		 		<tr>
		 			<?php 
                        ...
                        {
                            echo '<tr>';
                            echo '<td>'. $dep['code_dep'] . '</td>';
                            echo '<td>'. $dep['empl_org'] . '</td>';
                            echo '<td>'. $dep['empl_des'] . '</td>';
                            echo '<td>'. $dep['desc_dep'] . '</td>';
                            echo '<td>'. $dep['qte'] . '</td>';
                            echo '</td>';
                            echo '</tr>';
                        }
